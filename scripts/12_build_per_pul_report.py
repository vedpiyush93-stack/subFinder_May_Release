...
def _pul_full_form(r: dict) -> str:
    ...
    return (
        ...
        f'<div class="meta-line">out-of-vocabulary: {r["oov_pct"]:.1f}% '
        f'({r["n_oov"]}/{r["n_tok"]} tokens never seen in this PUL\'s training fold)</div>'
        f'</div>'
...
def _overview_html() -> str:
    intro = (
        ...
        '<span class="tok tok-oov">novel_tok</span>red dashed = OOV = <b>o</b>ut-<b>o</b>f-<b>v</b>ocabulary (token never seen in this fold\'s training set) &nbsp;·&nbsp; '
...
def _pul_compact_card(r: dict) -> str:
    ...
    return (
        ...
        f'TRUE: <b>{html.escape(r["true"])}</b> · pred: <b>{html.escape(r["pred"])}</b> '
        f'{rank_html} · '
        f'<span class="oov-tag" title="out-of-vocabulary tokens = tokens never seen in this PUL\'s training fold">'
        f'out-of-vocab {r["oov_pct"]:.1f}% ({r["n_oov"]}/{r["n_tok"]} tokens)</span>'
        f'</div>'
...
def _legend_strip() -> str:
    ...
    return (
        ...
        '<span class="tok tok-oov">novel_tok</span> <b>red dashed</b> = OOV = <b>o</b>ut-<b>o</b>f-<b>v</b>ocabulary (token never seen in any PUL of this fold\'s training set) &nbsp;·&nbsp; '
...
def _substrate_tab_html(class_name: str) -> str:
    ...
    summary = (
        ...
        f'<div class="stat"><div class="stat-label">mean out-of-vocab %</div><div class="stat-val">{mean_oov:.2f}%</div></div>'
        ...
        f'with out-of-vocabulary tokens (never seen in this fold\'s training set) highlighted in red.'
        f'</div>'
    )
