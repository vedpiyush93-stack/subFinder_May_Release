...
print(f"  grand-total wall time across all 625 fits: {grand_total_sec:.0f} s = {grand_total_sec/3600:.2f} h")
...
fig10.update_layout(
    title=dict(text=f"<b>Training time per classifier family</b><br>"
                    ...
                    f"Grand total across all 625 fits: <b>{grand_total_sec:.0f} s = {grand_total_sec/3600:.2f} h</b>.</span>",
               x=0, font=dict(color=CHARCOAL, size=18)),
...
<dl class="kv">
  ...
  <dt>Total</dt><dd>25 configs × 25 trials = 625 fits; bit-identical reproducibility on our sklearn winners</dd>
</dl>
"""
})
...
slide_html_blocks.append({
    ...
    "subtitle": (f"Why our shallow winner is cheap to train. Grand total across all 625 fits: "
